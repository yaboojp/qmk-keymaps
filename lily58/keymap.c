...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT, \
                        MO(_ADJUST),KC_LALT,KC_LGUI,    L_LANG2,  R_LANG1,  KC_SPC, KC_ESC, KC_BSPC \
),
...
[_LOWER] = LAYOUT( \
  ...
  _______,_______,  _______, _______, KC_EQL,  KC_PLUS, KC_LCBR, KC_RCBR,  _______, _______, _______, _______, _______, _______, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR,  KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, \
                             _______, _______, _______, _______, _______,  _______, _______, _______ \
),
